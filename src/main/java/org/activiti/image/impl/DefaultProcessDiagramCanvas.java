/**
 * 重写的activiti工作流的DefaultProcessDiagramCanvas类，已解决中文乱码问题
 */
...
public class DefaultProcessDiagramCanvas {
    ...
    public void initialize(String imageType) {
        ...
        try {
            USERTASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/userTask.png", this.customClassLoader));
            SCRIPTTASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/scriptTask.png", this.customClassLoader));
            SERVICETASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/serviceTask.png", this.customClassLoader));
            RECEIVETASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/receiveTask.png", this.customClassLoader));
            SENDTASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/sendTask.png", this.customClassLoader));
            MANUALTASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/manualTask.png", this.customClassLoader));
            BUSINESS_RULE_TASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/businessRuleTask.png", this.customClassLoader));
            SHELL_TASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/shellTask.png", this.customClassLoader));
            CAMEL_TASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/camelTask.png", this.customClassLoader));
            MULE_TASK_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/muleTask.png", this.customClassLoader));
            TIMER_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/timer.png", this.customClassLoader));
            ERROR_THROW_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/error-throw.png", this.customClassLoader));
            ERROR_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/error.png", this.customClassLoader));
            MESSAGE_THROW_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/message-throw.png", this.customClassLoader));
            MESSAGE_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/message.png", this.customClassLoader));
            SIGNAL_THROW_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/signal-throw.png", this.customClassLoader));
            SIGNAL_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/icons/signal.png", this.customClassLoader));
    ...
    public void drawStartEvent(GraphicInfo graphicInfo, BufferedImage image, double scaleFactor) {
        ...
        if (image != null) {
            this.g.drawImage(image, (int)(graphicInfo.getX() + graphicInfo.getWidth() / 4.0D), (int)(graphicInfo.getY() + graphicInfo.getHeight() / 4.0D), (int)((double)image.getWidth() / scaleFactor), (int)((double)image.getHeight() / scaleFactor), (ImageObserver)null);
        }
    ...
    public void drawArrowHead(java.awt.geom.Line2D.Double line, double scaleFactor) {
    ...
    public void drawDefaultSequenceFlowIndicator(java.awt.geom.Line2D.Double line, double scaleFactor) {
    ...
    public void drawConditionalSequenceFlowIndicator(java.awt.geom.Line2D.Double line, double scaleFactor) {
        if (scaleFactor <= 1.0D) {
            int horizontal = 11;
    ...
    protected void drawMultilineText(String text, int x, int y, int boxWidth, int boxHeight, boolean centered) {
        ...
        for(Iterator i$ = layouts.iterator(); i$.hasNext(); currentY = (int)((float)currentY + textLayout.getDescent() + textLayout.getLeading())) {
            textLayout = (TextLayout)i$.next();
    ...
    public List<GraphicInfo> connectionPerfectionizer(DefaultProcessDiagramCanvas.SHAPE_TYPE sourceShapeType, DefaultProcessDiagramCanvas.SHAPE_TYPE targetShapeType, GraphicInfo sourceGraphicInfo, GraphicInfo targetGraphicInfo, List<GraphicInfo> graphicInfoList) {
        ...
        Point p = null;
        java.awt.geom.Line2D.Double lineLast;
        if (shapeFirst != null) {
            lineLast = new java.awt.geom.Line2D.Double(graphicInfoFirst.getX(), graphicInfoFirst.getY(), ((GraphicInfo)graphicInfoList.get(1)).getX(), ((GraphicInfo)graphicInfoList.get(1)).getY());
        ...
        if (shapeLast != null) {
            lineLast = new java.awt.geom.Line2D.Double(graphicInfoLast.getX(), graphicInfoLast.getY(), ((GraphicInfo)graphicInfoList.get(graphicInfoList.size() - 2)).getX(), ((GraphicInfo)graphicInfoList.get(graphicInfoList.size() - 2)).getY());
    ...
    private static Shape createShape(DefaultProcessDiagramCanvas.SHAPE_TYPE shapeType, GraphicInfo graphicInfo) {
        if (DefaultProcessDiagramCanvas.SHAPE_TYPE.Rectangle.equals(shapeType)) {
            return new java.awt.geom.Rectangle2D.Double(graphicInfo.getX(), graphicInfo.getY(), graphicInfo.getWidth(), graphicInfo.getHeight());
        } else if (DefaultProcessDiagramCanvas.SHAPE_TYPE.Rhombus.equals(shapeType)) {
            java.awt.geom.Path2D.Double rhombus = new java.awt.geom.Path2D.Double();
            ...
            return DefaultProcessDiagramCanvas.SHAPE_TYPE.Ellipse.equals(shapeType) ? new Double(graphicInfo.getX(), graphicInfo.getY(), graphicInfo.getWidth(), graphicInfo.getHeight()) : null;
        }
    }

    private static Point getIntersection(Shape shape, java.awt.geom.Line2D.Double line) {
    ...
    private static Point getEllipseIntersection(Shape shape, java.awt.geom.Line2D.Double line) {
        double angle = Math.atan2(line.y2 - line.y1, line.x2 - line.x1);
    ...
    private static Point getShapeIntersection(Shape shape, java.awt.geom.Line2D.Double line) {
        ...
        for(; !it.isDone(); it.next()) {
            ...
            case 0:
                ...
                break;
            case 1:
                java.awt.geom.Line2D.Double l = new java.awt.geom.Line2D.Double(pos[0], pos[1], coords[0], coords[1]);
    ...
    static {
        ...
        LABEL_FONT = null;
        ANNOTATION_FONT = new Font("Arial", 0, 11);
        TASK_FONT = new Font("Arial", 0, 11);

...
public class SwfToolsUtil {
	public static void convert2SWF(String inputFile) {
		...
		}else if(extend.equals("doc")||extend.equals("docx")||extend.equals("xls")||extend.equals("pptx")||extend.equals("xlsx")||extend.equals("ppt")||extend.equals("txt")||extend.equals("odt")){

	...
	public StringBuffer end(){
		...
		if (oConvertUtils.isIn("bootstrap", types)) {
			if (!oConvertUtils.isIn("jquery", types)) {
				...
				//dzh：版本低于jquery-1.9.1.js页面检索按钮无效
				sb.append("<script type=\"text/javascript\" src=\""+basePath+"/plug-in/jquery/jquery-1.9.1.js\"></script>");
			}
		...
		if (oConvertUtils.isIn("common", types)) {
			sb.append("<script type=\"text/javascript\" charset=\"utf-8\" src=\""+basePath+"/webpage/common/js/common.js\"></script>");
			sb.append("<link rel=\"stylesheet\" href=\""+basePath+"/webpage/common/css/font-awesome.min.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\""+basePath+"/webpage/common/css/upload.css\" type=\"text/css\"></link>");
		}

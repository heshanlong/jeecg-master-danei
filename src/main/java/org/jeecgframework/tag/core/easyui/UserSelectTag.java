...
public class UserSelectTag extends TagSupport {
	...
	private String className; //样式class
	...
	public StringBuffer end() {
		...
		sb.append("<input class=\"inuptxt "+ className +"\" readonly=\""+readonly+"\" type=\"text\" id=\"" + selectedNamesInputId + "\" name=\"" + selectedNamesInputId + "\" style=\"width: "+inputWidth+"\" onclick=\"openUserSelect()\" ");

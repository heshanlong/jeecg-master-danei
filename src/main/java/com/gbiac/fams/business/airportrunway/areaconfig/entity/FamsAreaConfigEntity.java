package com.gbiac.fams.business.airportrunway.areaconfig.entity;
 ...
 */
@Entity
@Table(name = "fams_area_config", schema = "")
@SuppressWarnings("serial")
public class FamsAreaConfigEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  区域id
	 */
	public void setAreaId(java.lang.String userId){
		this.areaId = areaId;
	}
	/**
	 *方法: 取得java.lang.String
	...
	@Column(name ="CRAFTSITE",nullable=true,length=32)

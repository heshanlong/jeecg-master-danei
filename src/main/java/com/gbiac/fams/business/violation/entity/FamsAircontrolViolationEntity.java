package com.gbiac.fams.business.violation.entity;
 ...
 */
@Entity
@Table(name = "fams_aircontrol_violation", schema = "")
@SuppressWarnings("serial")
public class FamsAircontrolViolationEntity implements java.io.Serializable {
	/**主键*/
	...
	/**控制区通行证号*/
	@Excel(name="控制区通行证号",width=15)
	private java.lang.String apronCard;
	/**车牌号*/
	...
	/**处罚依据*/
	@Excel(name="处罚依据",width=15)
	private java.lang.String panishRule;
	/**机坪处理*/
	@Excel(name="机坪处理",width=15,dicCode="voi_d_str")
	private java.lang.String apronPanishResult;
	/**派发日期*/
	@Excel(name="派发日期",width=15,format = "yyyy-MM-dd HH:mm")
	private java.util.Date decideDate;
	/**派发日期*/
	@Excel(name="开单时间",width=15,format = "yyyy-MM-dd HH:mm")
	private java.util.Date dealDate;
	/**派发人*/
	@Excel(name="派发人",width=15)
	private java.lang.String decideName;
	/**准入处理*/
	@Excel(name="准入处理",width=15)
	private java.lang.String accessPanishResult;
	/**处理人*/
	...
	/**状态1派发2处理完成3已接收4已撤销*/
	@Excel(name="状态",width=15,dicCode="vio_status")
	...
	@Column(name ="VIOLATION_ADDR",nullable=true,length=64)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  控制区通行证号
	 */

	@Column(name ="APRON_CARD",nullable=true,length=32)
	public java.lang.String getApronCard(){
		return this.apronCard;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  控制区通行证号
	 */
	public void setApronCard(java.lang.String apronCard){
		this.apronCard = apronCard;
	}
	/**
	 *方法: 取得java.lang.String
	...
	@Column(name ="CAR_NUMBER",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  处罚依据
	 */

	@Column(name ="PANISH_RULE",nullable=true,length=32)
	public java.lang.String getPanishRule(){
		return this.panishRule;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  处罚依据
	 */
	public void setPanishRule(java.lang.String panishRule){
		this.panishRule = panishRule;
	}
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  机坪处理
	 */

	@Column(name ="APRON_PANISH_RESULT",nullable=true,length=64)
	public java.lang.String getApronPanishResult(){
		return this.apronPanishResult;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  机坪处理
	 */
	public void setApronPanishResult(java.lang.String apronPanishResult){
		this.apronPanishResult = apronPanishResult;
	}
	/**
	 *方法: 取得java.util.Date
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  准入处理
	 */

	@Column(name ="ACCESS_PANISH_RESULT",nullable=true,length=128)
	public java.lang.String getAccessPanishResult(){
		return this.accessPanishResult;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  准入处理
	 */
	public void setAccessPanishResult(java.lang.String accessPanishResult){
		this.accessPanishResult = accessPanishResult;
	}
	/**
	 *方法: 取得java.lang.String
	...
	@Column(name ="DEAL_NAME",nullable=true,length=32)
	...
	@Column(name ="REBACKDES",nullable=true,length=32)

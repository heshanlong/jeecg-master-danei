...
public class IndexEntity implements java.io.Serializable {
	...
	/**航班注册号*/
	@Excel(name="航班注册号",width=15)
	private java.lang.String flightregistrationnumber;
	/**航空公司*/
	@Excel(name="航空公司",width=15)
	...
	/**计划进港时间*/
	@Excel(name="计划进港时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date plannedtime;
	/**计划出港时间*/
	@Excel(name="计划出港时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date planneddeparture;
	/**实际进港时间*/
	@Excel(name="实际进港时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date actualtimearrival;
	/**实际出港时间*/
	@Excel(name="实际出港时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date actualdeparture;
	/**通报场道时间*/
	@Excel(name="通报场道时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date announcetracktime;
	/**通报值班领导时间*/
	@Excel(name="通报值班领导时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date announcedutytime;
	/**通报AOC时间*/
	@Excel(name="通报AOC时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date notificationaoctime;
	/**通报机坪时间*/
	@Excel(name="通报机坪时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date transactiontime;
	/**漏油种类*/
	@Excel(name="漏油种类",width=15)
	private java.lang.String oiltypes;
	/**漏油面积*/
	@Excel(name="漏油面积",width=15)
	private java.lang.String spillarea;
	/**漏油原因*/
	@Excel(name="漏油原因",width=15)
	private java.lang.String oilleakreason;
	/**影响运行区域*/
	@Excel(name="影响运行区域",width=15)
	private java.lang.String affectedoperationarea;
	/**启动燃油溢漏预案*/
	@Excel(name="启动燃油溢漏预案",width=15)
	...
	private java.util.Date lifttime;
	/**现场油迹清理完毕时间*/
	@Excel(name="现场油迹清理完毕时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date oilcleaningsite;
	/**飞机推出时间*/
	@Excel(name="飞机推出时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date aircraftlaunchtime;
	/**机位可用时间*/
	@Excel(name="机位可用时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date availabletime;
	/**相关滑行道可用时间*/
	@Excel(name="相关滑行道可用时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date relevanttaxiwayavailabilitytime;
	/**通报AOC时间*/
	@Excel(name="通报AOC时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date notificationofaoctime;
	/**通报值班领导时间*/
	@Excel(name="通报值班领导时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date announcetheleaderonduty;
	/**补充说明*/
	@Excel(name="补充说明",width=255)
	private java.lang.String added;
	/**图片路径*/
	@Excel(name="图片路径",width=15)
	private java.lang.String files;
	/**飞机自主转弯*/
	@Excel(name="飞机自主转弯",width=15)
	private java.lang.String autonomousturning;
	/**引领车辆等待位置*/
	@Excel(name="引领车辆等待位置",width=15)
	private java.lang.String guidevehicleswaitingposition;
	/**引领路线*/
	@Excel(name="引领路线",width=15)
	private java.lang.String leadline;
	/**拖车到达等待点时间*/
	@Excel(name="拖车到达等待点时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date trailerarrivalwaitingtime;
	/**引领车辆到达等待点时间*/
	@Excel(name="引领车辆到达等待点时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date leadvehiclethewaitingpointtime;
	/**开始引领时间*/
	@Excel(name="开始引领时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date leadtime;
	/**飞机进位时间*/
	@Excel(name="飞机进位时间",width=15,format = "yyyy-MM-dd")
	private java.util.Date aircraftcarrytime;
	/**飞机拖动路线*/
	@Excel(name="飞机拖动路线",width=15)
	private java.lang.String aircraftdragroute;
	/**拖车拖动补充说明*/
	@Excel(name="拖车拖动补充说明",width=255)
	...
	@Column(name ="SOURCEFORMATION",nullable=true,length=255)
	...
	@Column(name ="FLIGHTREGISTRATIONNUMBER",nullable=true,length=50)
	...
	@Column(name ="AIRLINES",nullable=true,length=32)
	...
	@Column(name ="ROUTES",nullable=true,length=50)
	...
	@Column(name ="MODELS",nullable=true,length=50)
	...
	@Column(name ="IMMEDIATELY",nullable=true,length=50)
	...
	@Column(name ="SLOTS",nullable=true,length=50)
	...
	public java.util.Date getPlannedtime(){
	 ...
	 */
	public void setPlannedtime(java.util.Date plannedtime){
	...
	public java.util.Date getPlanneddeparture(){
	 ...
	 */
	public void setPlanneddeparture(java.util.Date planneddeparture){
	...
	public java.util.Date getActualtimearrival(){
	 ...
	 */
	public void setActualtimearrival(java.util.Date actualtimearrival){
	...
	public java.util.Date getActualdeparture(){
	 ...
	 */
	public void setActualdeparture(java.util.Date actualdeparture){
	...
	public java.util.Date getAnnouncetracktime(){
	 ...
	 */
	public void setAnnouncetracktime(java.util.Date announcetracktime){
	...
	public java.util.Date getAnnouncedutytime(){
	 ...
	 */
	public void setAnnouncedutytime(java.util.Date announcedutytime){
	...
	public java.util.Date getNotificationaoctime(){
	 ...
	 */
	public void setNotificationaoctime(java.util.Date notificationaoctime){
	...
	@Column(name ="OILTYPES",nullable=true,length=10)
	...
	@Column(name ="SPILLAREA",nullable=true,length=10)
	...
	@Column(name ="OILLEAKREASON",nullable=true,length=10)
	...
	@Column(name ="STARTUPTIME",nullable=true)
	 ...
	 */
	public void setStartuptime(java.util.Date startuptime){
	...
	@Column(name ="LIFTTIME",nullable=true)
	public java.util.Date getLifttime(){
	 ...
	 */
	public void setLifttime(java.util.Date lifttime){
	...
	@Column(name ="OILCLEANINGSITE",nullable=true)
	public java.util.Date getOilcleaningsite(){
	 ...
	 */
	public void setOilcleaningsite(java.util.Date oilcleaningsite){
	...
	@Column(name ="AIRCRAFTLAUNCHTIME",nullable=true)
	public java.util.Date getAircraftlaunchtime(){
	 ...
	 */
	public void setAircraftlaunchtime(java.util.Date aircraftlaunchtime){
	 ...
	 */
	public void setAvailabletime(java.util.Date availabletime){
	...
	@Column(name ="RELEVANTTAXIWAYAVAILABILITYTIME",nullable=true)
	public java.util.Date getRelevanttaxiwayavailabilitytime(){
	 ...
	 */
	public void setRelevanttaxiwayavailabilitytime(java.util.Date relevanttaxiwayavailabilitytime){
	...
	@Column(name ="NOTIFICATIONOFAOCTIME",nullable=true)
	public java.util.Date getNotificationofaoctime(){
	 ...
	 *@param: java.util.Date  通报AOC时间
	 */
	public void setNotificationofaoctime(java.util.Date notificationofaoctime){
	...
	@Column(name ="ANNOUNCETHELEADERONDUTY",nullable=true)
	public java.util.Date getAnnouncetheleaderonduty(){
	 ...
	 *@param: java.util.Date  通报值班领导时间
	 */
	public void setAnnouncetheleaderonduty(java.util.Date announcetheleaderonduty){
	...
	@Column(name ="ADDED",nullable=true,length=255)
	...
	@Column(name ="AUTONOMOUSTURNING",nullable=true,length=10)
	...
	@Column(name ="GUIDEVEHICLESWAITINGPOSITION",nullable=true,length=10)
	...
	@Column(name ="LEADLINE",nullable=true,length=10)
	...
	@Column(name ="TRAILERARRIVALWAITINGTIME",nullable=true)
	public java.util.Date getTrailerarrivalwaitingtime(){
	 ...
	 */
	public void setTrailerarrivalwaitingtime(java.util.Date trailerarrivalwaitingtime){
	...
	@Column(name ="LEADVEHICLETHEWAITINGPOINTTIME",nullable=true)
	public java.util.Date getLeadvehiclethewaitingpointtime(){
	 ...
	 */
	public void setLeadvehiclethewaitingpointtime(java.util.Date leadvehiclethewaitingpointtime){
	 ...
	 */
	public void setLeadtime(java.util.Date leadtime){
	...
	@Column(name ="AIRCRAFTCARRYTIME",nullable=true)
	public java.util.Date getAircraftcarrytime(){
	 ...
	 */
	public void setAircraftcarrytime(java.util.Date aircraftcarrytime){
	...
	@Column(name ="TRAILERDRAGADDED",nullable=true,length=255)

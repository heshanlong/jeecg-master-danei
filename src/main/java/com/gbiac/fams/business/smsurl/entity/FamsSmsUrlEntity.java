package com.gbiac.fams.business.smsurl.entity;
 ...
 */
@Entity
@Table(name = "fams_sms_url", schema = "")
@SuppressWarnings("serial")
public class FamsSmsUrlEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  业务key
	 */

	@Column(name ="KEY_CODE",nullable=true,length=32)

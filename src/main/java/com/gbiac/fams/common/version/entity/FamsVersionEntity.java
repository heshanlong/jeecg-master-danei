package com.gbiac.fams.common.version.entity;
 ...
 */
@Entity
@Table(name = "fams_version", schema = "")
@SuppressWarnings("serial")
public class FamsVersionEntity implements java.io.Serializable {
	/**主键*/
	...
	/**平台*/
	@Excel(name="平台",width=15,dicCode="sf_yn")
	private java.lang.String platform;
	/**版本介绍*/
	@Excel(name="版本介绍",width=15)
	private java.lang.String remark;
	/**版本大小*/
	@Excel(name="版本大小",width=15)
	...
	@Column(name ="PLATFORM",nullable=true,length=10)

...
<form class="form-horizontal" role="form" id="formobj" action="famsWorkAppStateController.do?doAdd" method="POST">
			...
			<div class="row">
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input id="flag" name="flag"  type="text" class="form-control input-sm" maxlength="10"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input id="state" name="state"  type="text" class="form-control input-sm" maxlength="10"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
			</div>

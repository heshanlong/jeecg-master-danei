...
<style>
 ...
 <div class="container" style="width:100%;">
	...
	<div class="panel-body">
		<form class="form-horizontal" role="form" id="formobj" action="famsAircontrolReformController.do?doReform" method="POST">
	...
	<div class="form-group">
        ...
        <%--<div class="form-group">--%>
            ...
            <%--<div class="col-sm-7">--%>
                <%--<div class="input-group" style="width:100%">--%>
                    <%--<input disabled="disabled" id="reformDate" name="reformDate" type="text" class="form-control input-sm laydate-date" placeholder="请输入派发日期"  ignore="ignore"  value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm' type='date' value='${famsAircontrolReform.reformDate}'/>" />--%>
                    <%--<span class="input-group-addon" ><span class="glyphicon glyphicon-calendar"></span></span>--%>
                <%--</div>--%>
            <%--</div>--%>
        <%--</div>--%>
	...
	<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7" style="">
				<jsp:include page= "/webpage/common/jsp/upload.jsp">
					...
					<jsp:param name= "name" value= "pictureAf"/>
		...
		<div class="form-group" style="margin-top: 15px">
			<label for="reformWay" class="col-sm-3 control-label"><span style="color:red;">*</span>整改措施：</label>
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea name="reformWay" class="form-control input-sm" rows="6" maxlength="1000" datatype="*" placeholder="请输入整改措施(小于1000字)" ignore="checked" >${famsAircontrolReform.reformWay}</textarea>

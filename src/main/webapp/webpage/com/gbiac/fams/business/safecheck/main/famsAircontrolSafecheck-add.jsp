			...
			<div class="footb">
				...
				<div class="foota" style="border-right:1px solid black">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input name="checkDate" type="text" class="form-control laydate-date"  ignore="checked" datatype="*"  value="<fmt:formatDate pattern='yyyy-MM-dd' type='date' value='${defaultDate}' />"/>
				...
				<div class="foota" style="border-right:1px solid black">
                    <div class="form-group">
                        <label for="checkTimeStart" class="col-sm-3 control-label"><span style="color:red;">*</span>检查时间：</label>
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input name="checkTimeStart" type="text" class="form-control laydate-time" style="width:130px;" value="<fmt:formatDate pattern='HH:mm' type='time' value='${defaultDate}' />"/>
                                <span style="float:left">&nbsp;-&nbsp;</span>
                                <input name="checkTimeEnd" type="text" class="form-control laydate-time"  style="width:150px;" placeholder="请输入检查完成时间" />
            ...
            <div class="footb">
            	...
            	<div class="foota" style="border-right:1px solid black">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input  id="airLine" name="airLine" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入航线"  ignore="checked" datatype="*" />
                            </div>
                        </div>
                    </div>
				</div>
                ...
                <div class="foota" style="border-right:1px solid black">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input id="airTail" name="airTail" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入机号"  ignore="checked" datatype="*" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="foota">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input id="airModel" name="airModel" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入机型" ignore="checked" datatype="*" />
                            </div>
                        </div>
                    </div>
                </div>
			...
			<div class="footb">
				<div class="foota" style="border-right:1px solid black">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input  id="preDate" name="preDate" type="text" class="form-control laydate-datetime" ignore="checked" datatype="*" placeholder="请输入预计落地时间"  />
                                <%--<span class="input-group-addon" ><span class="glyphicon glyphicon-calendar"></span></span>--%>
                            </div>
                        </div>
                    </div>
                ...
                <div class="foota" style="border-right:1px solid black">
                    <div class="form-group" >
                        ...
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input name="actualDate" id="actualDate" type="text" class="form-control laydate-datetime"   />
                                <%--<span class="input-group-addon" ><span class="glyphicon glyphicon-calendar"></span></span>--%>
                            </div>
                        </div>
                    </div>
                ...
                <div class="foota">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group" style="width:100%">
                                <input id="airSlots" name="airSlots" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入停机位"  ignore="checked" datatype="*" />
                            </div>
                        </div>
                    </div>
                </div>
		...
		<%--</div>--%>
								...
								<tr>
									...
									<c:if test="${'时间点检查项'==configvar.projectName}">
										...
										<c:forEach items="${configvar.configList}" var="configLisVar" varStatus="vs">
											<tr class="rd1">
												<th>${vs.index+1}</th>
												<th style="text-align: left">${configLisVar.projectDetail}</th>
												<th><input class="form-control i-checks radioInput" type="radio" name="${configLisVar.id}" value="${configLisVar.id}:1" checked /></th>
												<th><input class="form-control i-checks radioInput" type="radio" name="${configLisVar.id}" value="${configLisVar.id}:2" /></th>
												<th><input class="form-control i-checks radioInput" type="radio" name="${configLisVar.id}" value="${configLisVar.id}:3" /></th>
												<th><div style="width: 100px; display: inline-block">${configLisVar.eventName}:</div>
														<input name="arrayTime" id="${configLisVar.id}_arrayTime" type="text" style="width: 100px;" class="form-control laydate-time" placeholder="到场时间"/>
														<input name="completeTime" id="${configLisVar.id}_completeTime" type="text" style="width: 100px;" class="form-control laydate-time" placeholder="完成时间"/>
												</th>
											</tr>
										</c:forEach>
						...
						<table id="noMatchResult" cellpadding="2" cellspacing="0" border="0">
							...
							<c:forEach items="${famsAircontrolSafecheckconfigListEntity}" var="configvar" varStatus="vs">
								...
								<tr class="rd1 ignored">
									<th style="text-align: left">${configLisVar.projectDetail}</th>
									<th id="${configLisVar.id}" ><input id="${configLisVar.id}_action" type="text" maxlength="200" class="form-control input-sm"/></th>
								</tr>
								</c:forEach>
							</c:forEach>
			...
			<div class="bottom">
				...
				<div class="col-sm-10 control-label">
					<textarea name="remark" class="form-control input-sm" rows="6" ignore="ignore" maxlength="1000" placeholder="请输入备注（小于1000字）"></textarea>
				</div>
			</div>
            <div class="foot">
...
var testBsSuggest = $("#airNumber").bsSuggest({
   ...
   // url: "famsCommonController.do?loadFlightData?"+$("#airNumber").val(),
    ...
    effectiveFields: ['flightno','craftno','airlinefullcn'],            //有效显示于列表中的字段，非有效字段都会过滤，默认全部。
    effectiveFieldsAlias: {'flightno':'航班号','craftno':'机号','airlinefullcn':'航线'},       //有效字段的别名对象，用于 header 的显示
    delay: 20000,
    ...
    // console.log('onSetSelectValue: ', resultTemp.value[keyword.id-1]);

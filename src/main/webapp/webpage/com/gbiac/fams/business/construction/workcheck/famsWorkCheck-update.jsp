...
<div class="container" style="width:100%;">
	...
	<div class="panel-body">
		<input type="hidden" id="start" value='<fmt:formatDate value="${famsWorkCheck.workStartTime}" pattern="yyyy-MM-dd HH:mm"/>'>
		<input type="hidden" id="end" value='<fmt:formatDate value="${famsWorkCheck.workEndTime}" pattern="yyyy-MM-dd HH:mm"/>'>
		<form class="form-horizontal" role="form" id="formobj" action="famsWorkCheckController.do?doUpdate" method="POST">
			...
			<div style="width: 80%;margin: auto">
				...
				<h5>编号：${famsWorkCheck.numberContent}</h5>
				<div class="footb">
						...
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="checkTime" placeholder="请输入检查时间" value='<fmt:formatDate value="${famsWorkCheck.checkTime}" pattern="yyyy-MM-dd HH:mm"/>' name="checkTime" type="text" style="height: 28px;" class="form-control laydate-datetime Wdate"  datatype="*" ignore="checked"  />
					...
					<div class="foota">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="bid" name="bid" value="${famsWorkCheck.bid}" type="hidden"/>
									<input id="trueWorkName" name="workName" value="${famsWorkCheck.workName}" type="hidden"/>
									<input id="workNameTmp" type="hidden" value="${famsWorkCheck.workName}"/>
									<input id="workName" readonly="readonly" e type="text" class="form-control" maxlength="100" datatype="*" ignore="checked"/>
				...
				<div class="footb" style="border-right:1px solid black">
					<div class="foota" style="border-right:1px solid black">
						<div class="form-group" style="margin:0px;width: 100%">
							<label for="buildDepart" class="col-sm-4 control-label"><span style="color:red;">*</span>建设单位：</label>
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="buildDepart" value="${famsWorkCheck.buildDepart}" name="buildDepart" type="text" readonly="readonly" maxlength="200"
					...
					<div class="foota">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workPlace" value="${famsWorkCheck.workPlace}" name="workPlace" type="text" readonly="readonly" maxlength="200"
				...
				<div class="footb">
					<div class="foota" style="border-right:1px solid black">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workStartTime" autocomplete="off" placeholder="请输入作业队进场时间" value='<fmt:formatDate value="${famsWorkCheck.workStartTime}" pattern="yyyy-MM-dd HH:mm"/>' name="workStartTime" type="text" style="height: 28px;" class="form-control laydate-datetime Wdate"   datatype="*" ignore="checked"  />
									<span class="Validform_checktip"></span>
					...
					<div class="foota">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workEndTime" autocomplete="off" placeholder="请输入作业预计结束时间" value='<fmt:formatDate value="${famsWorkCheck.workEndTime}" pattern="yyyy-MM-dd HH:mm"/>' name="workEndTime" type="text" style="height: 28px;" class="form-control laydate-datetime Wdate"   datatype="*" ignore="ignore"  />
									<span class="Validform_checktip"></span>
											...
											<tr>
												<th colspan="5">
													<div style="float: left;width: 25%">
														<div>抽查车辆车牌号:</div>
														<input id="carNumber" value="${famsWorkCheck.carNumber}" name="carNumber" type="text" maxlength="200" style="width: auto"
															   class="form-control input-sm" placeholder="请输入车辆车牌号" datatype="*" ignore="ignore"/>
													</div>
													<div style="float: left;width: 25%">
														<div>驾驶员姓名:</div>
														<input id="carDriver" value="${famsWorkCheck.carDriver}" name="carDriver" type="text" maxlength="200" style="width: auto"
															   class="form-control input-sm" placeholder="请输入驾驶员姓名" datatype="*" ignore="ignore"/>
													</div>
													<div style="float: left;width: 25%">
														<div>驾驶证号:</div>
														<input id="driverLicense" value="${famsWorkCheck.driverLicense}" name="driverLicense" type="text" maxlength="200" style="width: auto"
															   class="form-control input-sm" placeholder="请输入驾驶证号" datatype="*" ignore="ignore"/>
													</div>
													<div style="float: left;width: 25%">
														<div>单位:</div>
														<input id="carDepart" value="${famsWorkCheck.carDepart}" name="carDepart" type="text" maxlength="200" style="width: auto"
															   class="form-control input-sm" placeholder="请输入单位" datatype="*" ignore="ignore"/>
													</div>
												</th>
											</tr>
											<c:forEach items="${list3}" var="item3" varStatus="vs3">
												<c:set value="${item3.id}" var="id"/>
												<tr>
													<th>${vs3.index+1}</th>
													<th style="text-align: left">${item3.name}</th>
													<th><input name="item[${item3.id}]" class="form-control i-checks" type="radio" value="符合" <c:if test="${item3.result=='符合'}">checked="checked"</c:if> /></th>
													<th><input name="item[${item3.id}]" class="form-control i-checks" type="radio" value="不符合" <c:if test="${item3.result=='不符合'}">checked="checked"</c:if>/></th>
													<th><input name="item[${item3.id}]" class="form-control i-checks" type="radio" value="不适用" <c:if test="${item3.result=='不适用'}">checked="checked"</c:if>/></th>
												</tr>
											</c:forEach>
										</c:when>
										<c:otherwise>
											<c:forEach items="${list3}" var="item3" varStatus="vs3">
												...
												<tr>
													<th>${vs3.index+1}</th>
													<th style="text-align: left">${item3.name}</th>
													<th><input name="item[${item3.id}]" class="form-control i-checks" datatype="*" type="radio" value="符合" <c:if test="${item3.result=='符合'}">checked="checked"</c:if> /></th>
													<th><input name="item[${item3.id}]" class="form-control i-checks" datatype="*" type="radio" value="不符合" <c:if test="${item3.result=='不符合'}">checked="checked"</c:if>/></th>
													<th><input name="item[${item3.id}]" class="form-control i-checks" datatype="*" type="radio" value="不适用" <c:if test="${item3.result=='不适用'}">checked="checked"</c:if>/></th>
												</tr>
											</c:forEach>
										</c:otherwise>
									</c:choose>
				...
				<div class="bottom1 other">
					...
					<div class="col-sm-10 control-label">
						<textarea name="checkResultNote" class="form-control input-sm" rows="4" placeholder="请输入检查小结（小于1000字）" maxlength="1000"   ignore="checked" datatype="*" >${famsWorkCheck.checkResultNote}</textarea>
					</div>
				</div>
				<div class="bottom1">
					<label for="checkRepairNote" class="col-sm-2 control-label">整改意见：</label>
					<div class="col-sm-10 control-label">
						<textarea name="checkRepairNote" class="form-control input-sm" rows="4" placeholder="请输入整改意见（小于1000字）" maxlength="1000" ignore="ignore">${famsWorkCheck.checkRepairNote}</textarea>
					</div>
				</div>
				<%--<div class="foot">
					<div class="foota" style="border-right:1px solid black">
						...
						<div class="col-sm-8">
							<div class="input-group" style="width:100%">
								<input id="aqSignature" value="${famsWorkCheck.aqSignature}" name="aqSignature" type="text" maxlength="200"
					...
					<div class="foota">
						...
						<div class="col-sm-6">
							<div class="input-group" style="width:100%">
								<input id="fxSignature" value="${famsWorkCheck.fxSignature}" name="fxSignature" type="text" maxlength="200"
									   class="form-control input-sm" placeholder="" datatype="*" ignore="checked"/>
							</div>
						</div>
					</div>

...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <div class="input-group" style="width:100%">
            <t:dictSelect field="approveState" type="radio" extendJson="{class:'approveState applyType i-checks'}"
                          typeGroupCode="sf_yn" hasLabel="false" defaultVal="Y" title="审批是否通过"
                          datatype="*"></t:dictSelect>
        </div>
    </div>
</div>
<div class="form-group" id="applyType">
    <label class="col-sm-3 control-label"><span style="color:red;">*</span>审批类型：</label>
    <div class="col-sm-7">
        <div class="input-group" style="width:100%">
            <t:dictSelect field="applyType" type="radio" extendJson="{class:'i-checks'}"
                          typeGroupCode="apply_type" hasLabel="false" defaultVal="${famsWorkApprove.applyType==null?'apply':famsWorkApprove.applyType}" title="报备类型"
                          datatype="*"></t:dictSelect>
        </div>
    </div>
</div>
...
<script type="text/javascript">
     ...
     * 提交审批
     */
    function s_department_apply_fun(submitBtn){
    ...
    $('.applyType').on('ifChecked', function(event){

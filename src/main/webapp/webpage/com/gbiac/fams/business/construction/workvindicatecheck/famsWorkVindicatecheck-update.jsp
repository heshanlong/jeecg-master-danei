...
<div class="container" style="width:100%;">
	...
	<div class="panel-body">
		<input type="hidden" id="start" value='<fmt:formatDate value="${famsWorkVindicatecheck.workStartTime}" pattern="yyyy-MM-dd HH:mm"/>'>
		<input type="hidden" id="end" value='<fmt:formatDate value="${famsWorkVindicatecheck.workEndTime}" pattern="yyyy-MM-dd HH:mm"/>'>
		<form class="form-horizontal" role="form" id="formobj" action="famsWorkVindicatecheckController.do?doUpdate" method="POST">
			...
			<div style="width: 80%;margin: auto">
				<h4>编号：<t:mutiLang langKey="workVindicateCheck_number"/></h4>
				<h1>飞行区管理部维护作业检查记录表</h1>
				<h5>编号：${famsWorkVindicatecheck.numberContent}</h5>
				<div class="footb">
						...
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="checkTime" placeholder="请输入检查时间" value="<fmt:formatDate value="${famsWorkVindicatecheck.checkTime}" pattern="yyyy-MM-dd HH:mm"/>" name="checkTime" type="text" style="height: 28px;" class="form-control laydate-datetime Wdate"  datatype="*" ignore="checked"  />
					...
					<div class="foota">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="bid" name="bid" value="${famsWorkVindicatecheck.bid}" type="hidden"/>
									<input id="trueWorkName" name="workName" value="${famsWorkVindicatecheck.workName}" type="hidden"/>
									<input id="workNameTmp" type="hidden" value="${famsWorkVindicatecheck.workName}"/>
				...
				<div class="footb">
					<div class="foota" style="border-right:1px solid black">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workPlace" value="${famsWorkVindicatecheck.workPlace}" name="workPlace" type="text" readonly="readonly" maxlength="200"
					...
					<div class="foota">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workDepart" value="${famsWorkVindicatecheck.workDepart}" name="workDepart" type="text" readonly="readonly" maxlength="200"
				...
				<div class="footb">
					<div class="foota" style="border-right:1px solid black">
						<div class="form-group" style="margin:0px;width: 100%">
							<label for="workStartTime" class="col-sm-4 control-label"><span style="color:red;">*</span>作业进场时间：</label>
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workStartTime" placeholder="请输入作业进场时间" value="<fmt:formatDate value="${famsWorkVindicatecheck.workStartTime}" pattern="yyyy-MM-dd HH:mm"/>" name="workStartTime" type="text" autocomplete="off" style="height: 28px;" class="form-control input-sm laydate-hxdate"  datatype="*" ignore="checked"  />
									<span class="Validform_checktip"></span>
									<label class="Validform_label" style="display: none;">作业进场时间</label>
								</div>
							</div>
						</div>
					</div>
					<div class="foota">
						<div class="form-group" style="margin:0px;width: 100%">
							<label for="workEndTime" class="col-sm-4 control-label">作业队撤场时间：</label>
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workEndTime" placeholder="请输入作业队撤场时间" value="<fmt:formatDate value="${famsWorkVindicatecheck.workEndTime}" pattern="yyyy-MM-dd HH:mm"/>" name="workEndTime" type="text" autocomplete="off"  style="height: 28px;" class="form-control input-sm laydate-hxdate"  datatype="*" ignore="ignore"  />
									<span class="Validform_checktip"></span>
									<label class="Validform_label" style="display: none;">作业队撤场时间</label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="bottom1 other">
					<label for="checkResultNote" class="col-sm-2 control-label"><span style="color:red;">*</span>作业小结：</label>
					<div class="col-sm-10 control-label">
						<textarea name="checkResultNote" class="form-control input-sm" rows="4" maxlength="1000" placeholder="请输入作业小结（小于1000字）" datatype="*" ignore="checked">${famsWorkVindicatecheck.checkResultNote}</textarea>
					</div>
				</div>
				<div class="bottom1">
					<label for="checkRepairNote" class="col-sm-2 control-label">整改措施：</label>
					<div class="col-sm-10 control-label">
						<textarea name="checkRepairNote" class="form-control input-sm" rows="4" maxlength="1000" ignore="ignore" placeholder="请输入整改措施（小于1000字）">${famsWorkVindicatecheck.checkRepairNote}</textarea>
					</div>
				</div>
				<%--<div class="foot">
                    <div class="foota" style="border-right:1px solid black">
				...
				<div class="foot">
					...
					<div class="col-sm-10">
						<jsp:include page= "/webpage/common/jsp/upload.jsp">
							...
							<jsp:param name= "directory" value= "vindicateCheck"/>
...
<script type="text/javascript">
    ...
    var testBsSuggest = $("#workName").bsSuggest({
        url: "famsWorkApproveController.do?bsSuggest&workType=vindicateCheck&keyword="+$("#workName").val(),
        idField: "id",
        showBtn: false,
        showHeader: false,
        getDataMethod: 'data',

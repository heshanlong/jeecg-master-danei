		...
		<form class="form-horizontal" role="form" id="formobj" action="famsWorkVindicatecheckController.do?doAdd" method="POST">
			...
			<div style="width: 80%;margin: auto">
						...
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="checkTime" placeholder="请输入检查时间" name="checkTime" type="text" style="height: 28px;" class="form-control laydate-datetime Wdate"  datatype="*" ignore="checked"  value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm' type='date' value='${nowdate}'/>"/>
				...
				<div class="footb">
					<div class="foota" style="border-right:1px solid black">
						<div class="form-group" style="margin:0px;width: 100%">
							<label for="workStartTime" class="col-sm-4 control-label">
								<span style="color:red;">*</span>作业进场时间：</label>
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workStartTime" placeholder="请输入作业进场时间"   name="workStartTime" type="text" style="height: 28px;" class="form-control laydate-datetime Wdate"  autocomplete="off"  datatype="*" ignore="checked"  />
									<span class="Validform_checktip"></span>
					...
					<div class="foota">
						<div class="form-group" style="margin:0px;width: 100%">
							...
							<div class="col-sm-8">
								<div class="input-group" style="width:100%">
									<input id="workEndTime" placeholder="请输入作业撤场时间"   name="workEndTime" type="text" style="height: 28px;" class="form-control laydate-datetime Wdate"  autocomplete="off"  datatype="*" ignore="ignore"  />
									<span class="Validform_checktip"></span>
				...
				<div class="bottom1 other">
					...
					<div class="col-sm-10 control-label">
						<textarea name="checkResultNote" class="form-control input-sm" rows="4" maxlength="1000" datatype="*" ignore="checked" placeholder="请输入作业小结（小于1000字）"></textarea>
					</div>
				</div>
				<div class="bottom1">

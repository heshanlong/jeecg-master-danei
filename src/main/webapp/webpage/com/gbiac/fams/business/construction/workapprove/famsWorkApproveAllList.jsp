...
<t:datagrid name="famsWorkApproveList" component="bootstrap-table" checkbox="true" sortName="createDate"
            ...
            actionUrl="famsWorkApproveController.do?allDatagrid" idField="id" fit="true" queryMode="group">
    ...
    <t:dgCol title="施工申报单位"  field="workDepart"  hidden="false" query="true" queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="施工区域" field="workArea" showLen="10" query="true" queryMode="single" width="120"></t:dgCol>
    <t:dgCol title="施工申报单位"  field="workApproveDepart"  hidden="true" queryMode="single"  width="120"></t:dgCol>

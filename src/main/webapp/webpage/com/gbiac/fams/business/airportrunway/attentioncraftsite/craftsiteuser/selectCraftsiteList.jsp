...
<t:datagrid style="width:400px;height:250px;" height="500px;" width="600" name="famsAttentionCraftsiteList" component="bootstrap-table"  checkbox="true" sortName="id"   sortOrder="asc"  pagination="true" fitColumns="true" title="机位" actionUrl="famsAttentionCraftsiteUserController.do?selectCraftsiteDatagrid" idField="id"  fit="true" queryMode="group">

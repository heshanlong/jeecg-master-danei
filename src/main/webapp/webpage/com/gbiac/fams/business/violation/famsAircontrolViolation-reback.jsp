    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" id="formobj" action="famsAircontrolViolationController.do?doReback" method="POST">
            ...
            <div class="row">
                ...
                <%--</div>--%>
                <%--<div class="col-md-9 col-sm-9 col-xs-9 bt-content">--%>
                <%--<input type="hidden" id="panishRule" name="panishRule" value="测试"/>--%>

                <%--<p><input type="checkbox"  id="1" value="《民用机场运行安全管理规定》第"/>《民用机场运行安全管理规定》第<input type="text" style="width: 30px;" value="">条</p>--%>
                <%--<p><input type="checkbox"  id="2" value="《民用机场航空器活动区道路交通安全管理规则》第"/>《民用机场航空器活动区道路交通安全管理规则》第<input type="text" style="width: 30px;" value="">条</p>--%>
                <%--<p><input type="checkbox"  id="3" value="《广州白云国际机场航空器活动区地面运行管理规定》第"/>《广州白云国际机场航空器活动区地面运行管理规定》第<input type="text" style="width: 30px;" value="">条</p>--%>
                <%--<p><input type="checkbox"  id="4" value="《广州白云国际机场航空器活动区道路交通安全管理实施细则》第"/>《广州白云国际机场航空器活动区道路交通安全管理实施细则》第<input type="text" style="width: 30px;" value="">条</p>--%>
                <%--<p><input type="checkbox"  id="5" value="《广州白云国际机场航空器活动区车辆设备停放管理实施细则》第"/>《广州白云国际机场航空器活动区车辆设备停放管理实施细则》第<input type="text" style="width: 30px;"  value="">条</p>--%>
                <%--<p><input type="checkbox"  id="6" value="《广州白云国际机场航空器活动区文明行为规范》第"/>《广州白云国际机场航空器活动区文明行为规范》第<input type="text" style="width: 30px;" value="">条</p>--%>
                ...
                <div class="bt-item col-md-6 col-sm-6">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-3 bt-label">
                            <span style="color:red;">*</span>撤销理由：
                        </div>
                        <div class="col-md-9 col-sm-9 col-xs-9 bt-content">
                            <textarea placeholder="请输入撤销理由(小于1000字)" maxlength="1000" name="rebackDes" class="form-control input-sm" rows="6" ignore="checked" datatype="*" ></textarea>
                            <span class="Validform_checktip" style="float:left;height:0px;"></span>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(":input:not(':last')").attr("readonly","readonly");

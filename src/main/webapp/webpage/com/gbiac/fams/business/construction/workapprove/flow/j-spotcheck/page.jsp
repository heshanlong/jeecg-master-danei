...
<div class="form-group">
    <label class="col-sm-3 control-label"><span style="color:red;">*</span>抽查结果：</label>
    <div class="col-sm-7">
...
<div class="form-group">
    <label class="col-sm-3 control-label">抽查意见：</label>
    <div class="col-sm-7">
        <div class="input-group" style="width:100%">
...
<script type="text/javascript">
     ...
     * 提交申请
     */
    function j_spotcheck_fun(submitBtn){
        layer.confirm('确定提交吗？',{
            btn:['确认','取消']
        },function(index) {

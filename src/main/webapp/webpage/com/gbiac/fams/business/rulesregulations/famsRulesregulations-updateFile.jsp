...
<script src="webpage/com/gbiac/fams/business/rulesregulations/js/famsRulesregulations.js" type="text/javascript"></script>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="famsRulesregulationsController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr style="background-color: #fff;">
					...
					<td class="value">
					     	<input id="pid" name="pid" type="hidden" style="width: 300px" class="inputxt" value='${famsRulesregulationsPage.pid}' ignore="ignore" />
					     	<input id="" name="" type="text" maxlength="100" disabled="disabled" style="width: 300px;height: 30px;" class="inputxt" value='${famsRulesregulationsPage.pName}' datatype="*" />
				...
				<!--<tr style="background-color: #fff;">
					...
					<td class="value">
					     	...
					     	<input id="rulesName" name="rulesName" type="text" maxlength="20" style="width: 300px;height: 30px;" class="inputxt" value="${famsRulesregulationsPage.rulesName}" datatype="*" onchange="onkeyupcc('${famsRulesregulationsPage.rulesName}')"/>
							<span class="Validform_checktip"></span>
				...
				<tr style="background-color: #fff;">
					...
					<td class="value">
					     	<input id="keyword2" name="keyword" type="text" maxlength="20" style="width: 300px;height: 30px;" class="inputxt" value='${famsRulesregulationsPage.keyword}' datatype="*" />
							<span class="Validform_checktip"></span>
				...
				<tr style="background-color: #fff;">
					...
					<td class="value">
					     	<input id="visible" name="visible" type="radio" value='0' ${famsRulesregulationsPage.visible==0?'checked':''} />所有人&nbsp;&nbsp;&nbsp;
					     	<input id="visible" name="visible" type="radio" value='1' ${famsRulesregulationsPage.visible==1?'checked':''}/>飞管内部可见&nbsp;&nbsp;&nbsp;
							<span class="Validform_checktip"></span>
				...
				<tr style="background-color: #fff;">
					...
					<td class="value">
					     	<input id="dispatchDate" name="dispatchDate" type="text" maxlength="20" style="width: 300px;height: 30px;" class="inputxt Wdate form-control laydate-datetime" value="<fmt:formatDate pattern='yyyy-MM-dd' type='date' value='${famsRulesregulationsPage.dispatchDate}'/>" />
							<span class="Validform_checktip"></span>
				...
				<tr style="background-color: #fff;">
					...
					<td class="value">
					     	<input id="articleUnit" name="articleUnit" type="text" maxlength="20" style="width: 300px;height: 30px;" class="inputxt" value="${famsRulesregulationsPage.articleUnit}" />
							<span class="Validform_checktip"></span>
				...
				<tr style="background-color: #fff;">
					...
					<td class="value">
					     	<input id="genreClassification" name="genreClassification" type="text" maxlength="20" style="width: 300px;height: 30px;" class="inputxt" value="${famsRulesregulationsPage.genreClassification}"/>
							<span class="Validform_checktip"></span>
				...
				<tr style="background-color: #fff;">
					...
					<td class="value">
					     	<input id="replaceRegulations" name="replaceRegulations" type="text" maxlength="20" style="width: 300px;height: 30px;" class="inputxt" value="${famsRulesregulationsPage.replaceRegulations}"/>
							<span class="Validform_checktip"></span>
				...
				<tr style="background-color: #fff;">
					...
					<td class="value">
							<textarea rows="3" cols="20" name="remark"  class="inputxt" style="margin: 0px; width: 300px; height: 80px;">${famsRulesregulationsPage.remark}</textarea>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">名称</label>
						</td>
				</tr>

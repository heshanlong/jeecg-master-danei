...
<div class="form-group">
    <label class="col-sm-3 control-label"><span style="color:red;">*</span>检查结果：</label>
    <div class="col-sm-7">
        <div class="input-group" style="width:100%">
            <t:dictSelect field="approveState" type="radio" extendJson="{class:'approveState i-checks'}"
                          typeGroupCode="w_check" hasLabel="false" title="审批是否通过"
                          datatype="*"></t:dictSelect>
        </div>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">检查意见：</label>
    <div class="col-sm-7">
        <div class="input-group" style="width:100%">
            ...
            <label class="Validform_label" style="display: none">检查意见</label>
        </div>
    </div>
</div>
<%--流程操作区域--%>
<div style="text-align: center">
    <button type="button" class="ace_button" style="background-color: #2272CE"  onclick="${funname}('submitBtn')">提交</button>
...
<script type="text/javascript">
     ...
     * 提交审批
     */
    function j_check_fun(submitBtn){
        layer.confirm('确定提交该审批吗？',{
            btn:['确认','取消']
        },function(index) {

...
<t:datagrid name="famsWorkApproveList" component="bootstrap-table" checkbox="true" sortName="createDate"
            ...
            actionUrl="famsWorkApproveController.do?datagrid" idField="id" fit="true" queryMode="group">
    ...
    <t:dgToolBar title="录入" icon="icon-add" operationCode="#add" url="famsWorkApproveController.do?goAdd" funname="addRewrite" width="100%" height="100%"></t:dgToolBar>
    <t:dgToolBar title="重新提交" icon="icon-repeat" operationCode="#applyAgain" url="famsWorkApproveController.do?goUpdateForApplyAgain" funname="updateRewrite" width="100%" height="100%"></t:dgToolBar>
    <t:dgToolBar title="撤回" icon="icon-redo" operationCode="#undo" url="" funname="undo"  width="100%" height="100%"></t:dgToolBar>
        ...
        $.dialog({
            ...
            button: [{
                ...
                callback: function(){
                    ...
                    console.log(iframe);
                    if(window.sessionStorage.getItem("uploadSuccess")!=undefined){
                        var uploadSuccess=window.sessionStorage.getItem("uploadSuccess");
                        if(uploadSuccess!="true"){
                            iframe.showMe("文件未上传完，请耐心等待！");
                            return false;
                        }
                    }
                    window.sessionStorage.removeItem("uploadSuccess");

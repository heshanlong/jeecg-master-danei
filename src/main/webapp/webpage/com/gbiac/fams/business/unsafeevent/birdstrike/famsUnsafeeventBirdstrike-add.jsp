...
<style>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="famsUnsafeeventBirdstrikeController.do?doAdd" method="POST">
            ...
            <table style="width: 100%">
                    ...
                    <tr>
                            ...
                            <td class="rd1 col-md-3">
		                        <input name="thedate" type="text" style="height:26px"  readonly="readonly" placeholder="请输入日期" value="${sdf}" class="form-control input-sm laydate-date" ignore="checked" datatype="*"  />
                            </td>
                            <td style="text-align: right;"  class="col-md-1" ><span style="color:red;">*</span>接报时间：</td>
                            <td class="rd1 col-md-3">
								<input name="settime" type="text" style="height:26px"  readonly="readonly" placeholder="请输入接报时间"  value="${sdff}" class="form-control input-sm laydate-ymdate" ignore="checked" datatype="*"  />
                            </td>
                            <td style="text-align: right;"  class="col-md-1" ><span style="color:red;">*</span>信息来源：</td>
                            <td class="rd1 col-md-3">
								<input name="sourceformation" type="text" style="height:26px"   placeholder="请输入信息来源" class="form-control input-sm" maxlength="1000" ignore="checked" datatype="*"   />
                            </td>
                ...
                <tr>
                    ...
                    <tr>
                            ...
                            <td class="rd1 col-md-3">
		                        <input placeholder="请输入痕迹部位" name="damagedlocation" type="text" style="height:26px"  class="form-control input-sm" maxlength="100"  ignore="ignore"  />
                            </td>
                            
                            <td style="text-align: right;"  class="col-md-1" >鸟击高度：</td>
                            <td class="rd1 col-md-3 bird-height">
								<t:dictSelect field="birdhighly" typeGroupCode="birdhighly" hasLabel="false"  type="radio" defaultVal="无法判定" extendJson="{  class:'isUseFire i-checks'}"></t:dictSelect>
                                <input  id="birdhighlyDetail" name="birdhighlyDetail"  type="text"  maxlength="100"  style="width:30x " ignore="checked"  maxlength="100"  oninput = "value=value.replace(/[^\d]/g,'')"  ignore="checked"  datatype="n0-100" placeholder="详细高度，选填" />m
                            </td>
                    ...
                    <tr>
                            ...
                            <td class="rd1 col-md-3">
								<t:dictSelect field="abody" typeGroupCode="youwu" hasLabel="false" defaultVal="W"  type="radio" extendJson="{  class:'isUseFire i-checks'}"></t:dictSelect>
                            </td>
                            <td style="text-align: right;"  class="col-md-1" >鸟毛：</td>
                            <td class="rd1 col-md-3">
								<t:dictSelect field="birdfeathers" typeGroupCode="youwu" hasLabel="false" defaultVal="W" type="radio" extendJson="{  class:'isUseFire i-checks'}"></t:dictSelect>
                            </td>
                    		<td style="text-align: right;"  class="col-md-1" >血迹：</td>
                            <td class="rd1 col-md-3">
		                        <t:dictSelect field="blood" typeGroupCode="njsj_xueji" hasLabel="false" defaultVal="W" type="radio" extendJson="{  class:'isUseFire i-checks'}"></t:dictSelect>
                            </td>
                    </tr>
                    <tr>
                    		<td style="text-align: right;white-space:nowrap"  class="col-md-1" >损伤尺寸长度（毫米）：</td>
                            <td class="rd1 col-md-3">
								<input placeholder="请输入损伤尺寸长度（单位为毫米）" name="woundsizelong" type="text" style="height:26px"  class="form-control input-sm" maxlength="100"  ignore="checked"  datatype="n0-100"  oninput = "value=value.replace(/[^\d]/g,'')"/>
                            </td>
                            <td style="text-align: right;white-space:nowrap"  class="col-md-1" >宽度（毫米）：</td>
                            <td class="rd1 col-md-3">
								<input placeholder="请输入损伤尺寸宽度（单位为毫米）" name="woundsizewide" type="text" style="height:26px"  class="form-control input-sm" maxlength="100"  ignore="checked"  datatype="n0-100" oninput = "value=value.replace(/[^\d]/g,'')" />
                            </td>
                    		<td style="text-align: right;white-space:nowrap"  class="col-md-1" >深度（毫米）：</td>
                            <td class="rd1 col-md-3">
		                        <input placeholder="请输入损伤尺寸深度（单位为毫米）" name="woundsizedeep" type="text" style="height:26px"  class="form-control input-sm" maxlength="100"  ignore="checked"  datatype="n0-100" oninput = "value=value.replace(/[^\d]/g,'')" />
                            </td>
                    </tr>
                    <tr>
                    		<td style="text-align: right;"  class="col-md-1" >航空器损伤：</td>
                            <td class="rd1 col-md-3">
								<t:dictSelect field="aircraftdamage" typeGroupCode="youwu" hasLabel="false" defaultVal="W" type="radio" extendJson="{  class:'isUseFire i-checks'}"></t:dictSelect>
                            </td>
                            <td style="text-align: right;"  class="col-md-1" >损伤部位：</td>
                            <td class="rd1 col-md-3">
								<input placeholder="请输入损伤部位" name="injury" type="text" style="height:26px"  class="form-control input-sm" maxlength="100"  ignore="ignore"  />
                            </td>
                    ...
                    <tr>
                            ...
                            <td class="rd1 col-md-3">
		                        <input placeholder="请输入通报生态时间" name="notificationecologicaltime"  readonly="readonly" type="text" style="height:26px"  class="form-control input-sm laydate-hxdate"  ignore="ignore"  />
                            </td>
                    ...
                    <tr>
                           ...
                           <td style="text-align: right;"  class="col-md-1" >查道开始时间：</td>
                            <td class="rd1 col-md-3">
								<input placeholder="请输入查道起时间"  name="trackstarttime" id="trackstarttime"  readonly="readonly"    type="text" style="height:26px"  class="form-control input-sm laydate-hxdate laydate-datetime"  ignore="ignore"  />
                            </td>
                            <td style="text-align: right;"  class="col-md-1" >查道结束时间：</td>
                            <td class="rd1 col-md-3">
								<input placeholder="请输入查道止时间"  name="trackcheckstoptime" id="trackcheckstoptime"  readonly="readonly"   type="text" style="height:26px"  class="form-control input-sm laydate-hxdate laydate-datetime"  ignore="ignore"  />
                            </td>
                    </tr>
                    <tr>
							<td style="text-align: right;"  class="col-md-1" >跑道检查：</td>
                            <td class="rd1 col-md-3">
								<t:dictSelect field="checkrunway" typeGroupCode="is_main" hasLabel="false"  type="radio" defaultVal="N" extendJson="{class:'isUseFire i-checks ischeckAt'}"></t:dictSelect>
                            </td>
                            <td style="text-align: right;"  class="col-md-1" >跑道：</td>
                            <td class="rd1 col-md-3">
								<c:forEach var="categoryList" items="${categoryList}">
                                <input id="runway"  name="runway" class="form-control i-checks"    datatype="*" type="radio" value="${categoryList.code}" ignore="checked"   />${categoryList.name}
                            ...
                            <td class="rd1 col-md-3">
		                        <t:dictSelect field="checkdirection" typeGroupCode="checkd" hasLabel="false"  datatype="" type="radio" extendJson="{  class:'isUseFire i-checks'}"></t:dictSelect>
                            </td>
                    </tr>
                    <tr>
                    		<td style="text-align: right;"  class="col-md-1" >跑道异物：</td>
                            <td class="rd1 col-md-3">
		                        <t:dictSelect field="runwayforeign"  typeGroupCode="youwu" hasLabel="false" type="radio" defaultVal="W" extendJson="{  class:'isUseFire i-checks'}"></t:dictSelect>
                            </td>
                            <td style="text-align: right;"  class="col-md-1" >鸟击类型：</td>
                            <td class="rd1 col-md-3">
								<t:dictSelect field="eventtype" typeGroupCode="eventtype" extendJson="{style:'width:100%'}" hasLabel="false"  type="select" ></t:dictSelect>
                            </td>
                    </tr>
                    <tr>
                            <td style="text-align: right;"  class="col-md-1" >补充说明：</td>
                            <td class="rd1 col-md-3">
								<textarea placeholder="请输入信息" name="added" cols="30" rows="5" maxlength="1000"  style="width:100%"></textarea>
                            </td>
                    </tr>
                    <tr>
    ...
    $.ajax({
        ...
        success: function (res) {
            // alert(res.data[0].flightno);
			 ...
			 $("#plannedtime").val(res.data[0].est);
			 $("#planneddeparture").val(res.data[0].sst);
			 $("#actualtimearrival").val(res.data[0].eat);
			 $("#actualdeparture").val(res.data[0].sat);
        },
        error:function (e) {
            layer.msg("访问数据失败")
        }
...
$("input[name='checkdirection']").each(function (i,val){
	$(val).attr("disabled", "disabled");
	//$(val).attr('checked', 'checked');
});

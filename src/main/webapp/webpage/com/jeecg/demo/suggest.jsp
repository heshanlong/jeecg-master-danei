...
<div class="container">
        ...
        <form action="index_submit" method="get" accept-charset="utf-8" role="form">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="testNoBtn" name="testNoBtn">
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <span class="caret"></span>
                            </button>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="testDbUser" name="testDbUser">
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <span class="caret"></span>
                            </button>
    ...
    var testBsSuggest = $("#testDbUser").bsSuggest({
        url: "jeecgListDemoController/loadSuggestData.do?keyword="+$("#testDbUser").val(),
        /*effectiveFields: ["userName", "shortAccount"],
        searchFields: [ "shortAccount"],
        effectiveFieldsAlias:{userName: "姓名"},*/
        idField: "rownum",
        ...
        effectiveFields: ['username','realname','depart'],            //有效显示于列表中的字段，非有效字段都会过滤，默认全部。
       // effectiveFieldsAlias: {'username':'用户名','realname':'姓名','depart':'部门'},       //有效字段的别名对象，用于 header 的显示
        delay: 0.5,
        //keyField: "realname;departname",
        keyField:"departname",  //每组数据的哪个字段作为输入框内容，优先级高于 indexKey 设置（推荐）
        ...
        console.log('onSetSelectValue: ', testDbrest.value[keyword.id-1].depart);
        $("#test").val(testDbrest.value[keyword.id-1].depart);
        $("#testNoBtn").val(testDbrest.value[keyword.id-1].username);

...
<head>
<title>用户信息</title>
<t:base type="jquery,easyui,tools,common"></t:base>
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			<td align="right" nowrap><label class="Validform_label">  <t:mutiLang langKey="common.createtime"/>: </label></td>
			<td class="value">
                <input class="easyui-datebox" name="createDate"  ignore="ignore"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
		
		<tr>
			<td align="right" nowrap><label class="Validform_label">  <t:mutiLang langKey="common.updatetime"/>: </label></td>
			<td class="value">
                <input class="easyui-datetimebox" name="updateDate"  datatype="m" ignore="ignore"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
...
<!-- 	  <div class="form">
      ...
      <input type="text" name="createDate" id="date" class="easyui-datebox"> 
      <span class="Validform_checktip"></span>
      </div>
      
      <div class="form">
      <label class="Validform_label"> 创建日期： </label> 
      <input type="text" name="updateDate" id="time" class="easyui-Timebox"> 
      <span class="Validform_checktip"></span>
      </div>  -->

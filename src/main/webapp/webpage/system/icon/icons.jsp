...
<%-- <t:upload name="file_upload" uploader="iconController.do?saveOrUpdateIcon" extend="*.png;" id="file_upload" formId="formobj"></t:upload> --%>
<%-- <t:webUploader name="file_upload" url="iconController.do?saveOrUpdateIcon" displayTxt="false" auto="true" buttonText="选择图标" buttonStyle="btn-blue btn-S" type="image" fileNumLimit="1" fileSingleSizeLimit=1024*20></t:webUploader> --%>
...
<t:formvalid formid="formobj" layout="div" dialog="true" beforeSubmit="upload">
    ...
    <div class="form" >
        ...
        <a target="_blank" href="${icon.iconPath }"><img src="${icon.iconPath }" style="width:20px;height:20px"></a>
        <input type="hidden" id = "existIcon" value = "1"/>
    </div>
    </c:if>
	<div class="form">
	<div id="filediv"></div>
	<t:upload name="file_upload" uploader="iconController.do?saveOrUpdateIcon" extend="pic" id="file_upload" formId="formobj" buttonText="选择图标" fileSizeLimit="20M" auto="true" view="true"></t:upload>
	<input type="hidden" id = "existIcon" value = "1"/></div>
	</fieldset>
</t:formvalid>
</body>
</html>

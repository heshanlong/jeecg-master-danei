...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
    ...
    <fieldset class="step">
        ...
        <div class="form">
            ...
            <%--dzh  去掉正则验证 --备份<input name="typename" class="inputxt" value="${type.typename }" datatype="/^[A-Za-z0-9\u4E00-\u9FA5\uf900-\ufa2d\.\s]{1,50}$/">--%>
        ...
        <div class="form">
            ...
            <%--dzh  去掉正则验证 --备份<input name="typecode" class="inputxt" value="${type.typecode }" datatype="/^[A-Za-z0-9\u4E00-\u9FA5\uf900-\ufa2d\.\s]{1,50}$/"--%>
